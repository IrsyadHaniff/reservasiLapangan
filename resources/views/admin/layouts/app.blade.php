    ...
    <div class="flex min-h-screen">
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                @php
                    $menus = [
                        ...
                        ['label' => 'Lapangan', 'route' => 'admin.lapangan.index', 'icon' => 'M3 3h18v18H3V3Zm0 9h18M12 3v18'],
                        ['label' => 'Reservasi', 'route' => 'admin.reservasi.index', 'icon' => 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2Z'],
                        ['label' => 'Laporan', 'route' => 'admin.laporan.index', 'icon' => 'M9 17v-6h6v6M9 17H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-2M9 17h6'],
                        ['label' => 'Jadwal', 'route' => 'admin.jadwal.index', 'icon' => 'M12 8v4l3 3m6-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z'],
                    ];
                @endphp
        ...
        <div class="flex-1 min-w-0">
            ...
            <main class="p-4 md:p-6">
                @if (session('success'))
                    <div class="mb-5 px-4 py-3 rounded-xl bg-court-available/10 border border-court-available/30 text-court-available text-sm no-print">
                        {{ session('success') }}
                    </div>
                @endif
                @if (session('error'))
                    <div class="mb-5 px-4 py-3 rounded-xl bg-court-booked/10 border border-court-booked/30 text-court-booked text-sm no-print">
                        {{ session('error') }}
                    </div>
                @endif
