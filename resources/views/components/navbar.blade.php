        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <a href="{{ url('/#reservasi') }}"
                   class="hidden md:inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-brand text-brand-black font-semibold text-sm hover:bg-[#4fd43f] hover:shadow-lg hover:shadow-brand/30 transition-all duration-200">
